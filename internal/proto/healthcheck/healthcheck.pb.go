...
const (
	HealthCheckResponse_UNKNOWN         HealthCheckResponse_ServingStatus = 0 // The server doesn’t know this service (maybe never registered).
	HealthCheckResponse_SERVING         HealthCheckResponse_ServingStatus = 1 // The service is up and working as expected.
	HealthCheckResponse_NOT_SERVING     HealthCheckResponse_ServingStatus = 2 // The service is running but unhealthy (misconfigured, degraded, etc).
...
type HealthCheckRequest struct {
	...
	Service       string                 `protobuf:"bytes,1,opt,name=service,proto3" json:"service,omitempty"` // The name of the service the client wants to know the status
...
const file_healthcheck_proto_rawDesc = "" +
	...
	"\x05Watch\x12\".grpc.health.v1.HealthCheckRequest\x1a#.grpc.health.v1.HealthCheckResponse0\x01B;Z9github.com/synchme/internal/proto/healthcheck;healthcheckb\x06proto3"
